...
export const ActionsCellRenderer = ({ api, node, setSelectedRowData, handleDeleteClick }) => {
    ...
    <>
      ...
      <DialogModel open={open} handleClose={() => setOpen(false)} title={
        ...
        <div className="d-flex justify-content-end gap-2 w-100">
          <Button variant="outlined" color="error" sx={{ padding: '3px 20px', '&:hover': { backgroundColor: 'var(--secondary-color)', color: 'white' } }} onClick={() => handleDeleteClick(node.data)}>{t(AppStrings.confirm)}</Button>
